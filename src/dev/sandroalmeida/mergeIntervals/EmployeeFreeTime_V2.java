...
public class EmployeeFreeTime_V2 {
    ...
    public static void main(String[] args) {
        ...
        List<Interval> result = EmployeeFreeTime_V2.findEmployeeFreeTime(input);
        ...
        result = EmployeeFreeTime_V2.findEmployeeFreeTime(input);
        System.out.print("Free intervals: ");
        for (Interval interval : result)
            System.out.print("[" + interval.start + ", " + interval.end + "] ");
        System.out.println();
